...
$(document).on("click", "#save" , function(e) {
    ...
    e.preventDefault();
    $("#toaster").remove();
    var myForm = document.getElementById('saadri_form');
        ...
        success : function(resData){
            ...
            if (validate === true) {
                if(status === true){
                    ...
                    setTimeout(function(){ window.location = base_url+'admin/saadri/list' }, 1000);
        ...
        success : function(resData){
            ...
            if(status === true){
                ...
                for( var i = 0; i<len; i++){
                    ...
                    var value = data[i]['first_name']+' '+data[i]['second_name']+' '+data[i]['third_name'];
