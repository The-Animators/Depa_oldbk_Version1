                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                <li>
                                    <a href="<?= base_url();?>admin/family/member-list" class="btn btn-raised btn-primary btn-round waves-effect">
                                        <?= $pagetitle?> List
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="body">
                            <form class="donation-form donor-details" id="member-form" method="POST">
                                <?php //print_r($familyHead);?>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label class="required">Select Head</label>
                                            </div>
                                            <div class="col-md-8">
                                                <select name="family_id" id="family_id" class="form-control ms show-tick ms select2" data-placeholder="Select Family Head">
                                                    ...
                                                    <?php 
                                                        foreach($familyHead as $key => $value){
                                                            echo '<option data-familypk-id="'.$value['id'].'" data-familyno="'.$value['family_no'].'" value="'.$value['family_id'].'">'.($value['fullname'] ?? ''). ' ('.$value['member_no'].')</option>';
                                                        }
                                                    ?>
                                                </select>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" thirdname>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label class="required">Third name</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php 
                                                        foreach($relation as $key => $value){
                                                            echo '<option data-type="'.$value['m_type'].'"  value="'.$value['id'].'" '.$value['m_type'].'>'.($value['relation'] ?? '').'</option>';
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row" style="margin-bottom: 10px">
                                            ...
                                            <div class="col-md-8">
                                                <div class="radio">
                                                    ...
                                                    <input type="radio" class="life_insurance" id="dark" name="life_insurance" checked value="0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="radio">
                                                    ...
                                                    <input type="radio" class="medical_insurance" id="mino" name="medical_insurance" checked value="0">
