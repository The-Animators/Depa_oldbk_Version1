                            ...
                            <form class="donation-form donor-details" id="member-form" method="POST">
                                ...
                                <div class="row">
                                                ...
                                                <select name="family_id" id="family_id" class="form-control ms show-tick ms select2" data-placeholder="Select Family Head">
                                                    ...
                                                    <?php 
                                                        foreach($familyHead as $key => $value){
                                                            ...
                                                            echo '<option data-familypk-id="'.$value['id'].'" '.$sel.' data-familyno="'.$value['family_no'].'" value="'.$value['family_id'].'">'.($value['fullname'] ?? ''). ' ('.$value['member_no'].')</option>';
                                                        }
                                                    ?>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <label>Member Current Status</label>
                                            </div>
                                            <div class="col-md-7">
                                                <select name="fm_status" id="fm_status" class="form-control ms show-tick ms " data-placeholder="Select Member Status">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" relation>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                       <select name="relation" id="relation" class="form-control ms select2">
                                                       <?php 
                                                       // print_r($relation);
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                       ...
                                                       <?php 
                                                        ...
                                                        <input type="hidden" name="education" id="education" value="<?= $result['education_id']?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                       ...
                                                       <?php 
                                                        ...
                                                        <input type="hidden" name="sports" id="sports" value="<?= $result['sports_id'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6" life_insurance style="background-color: #e1e1e1;padding: 10px;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="radio">
                                                        <input type="radio" class="life_insurance" id="light" name="life_insurance" value="1" <?php if($result['life_insurance'] == 1) echo 'checked'; ?> value="1">
                                                        <label for="light">Yes</label>
                                                        <input type="radio" class="life_insurance" id="dark" name="life_insurance" value="0" <?php if($result['life_insurance'] == 0) echo 'checked'; ?> value="1">
                                        ...
                                        <div class="col-md-6" medical_insurance  style="background-color: #ececec">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="radio">
                                                        <input type="radio" class="medical_insurance" id="miye" name="medical_insurance" value="1" <?php if($result['medical_insurance'] == 1) echo 'checked'; ?> >
                                                        <label for="miye">Yes</label>
                                                        <input type="radio" class="medical_insurance" id="mino" name="medical_insurance" value="0" <?php if($result['medical_insurance'] == 0) echo 'checked'; ?> >
                                            ...
                                            <div class="row" medical_insurance_ask style="display:none;" id="medical_insurance_ask">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="radio">
                                                        <input type="radio" class="sanjeevni" name="sanjeevni" id="sjye" value="1" <?php if($result['sanjeevni'] == 1) echo 'checked'; ?> >
                                                        <label for="sjye">Yes</label>
                                                        <input type="radio" class="sanjeevni" name="sanjeevni" id="sjno" value="0" <?php if($result['sanjeevni'] == 0) echo 'checked'; ?> >
