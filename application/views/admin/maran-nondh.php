            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="maran_nondh_form member-details" id="maran_nondh_form" method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6" date>
                            <div class="row">
                                <div class="col-md-5">
                                    <label class="required">Date of Maran Nondh</label>
                                </div>
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="mdate" name="mdate" placeholder="Date of Maran Nondh" value="<?= $result[0]['date'] ?? '';?>">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6" contact>
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <select name="death_contact[]" id="death_contact" class="form-control ms select" multiple>
                                        </select>
                                    </div>
                                    <p>Please use <b>CTRL</b> to multi select</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" achievements>
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <textarea class="form-control" id="description" name="description" style="min-height:130px;resize: none;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
