    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">New User</h4>
            </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="education" name="education" class="form-control" placeholder="<?= $pagetitle;?>">
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-round waves-effect" id="save">SAVE Education</button>
