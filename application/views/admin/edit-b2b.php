                            ...
                            <form class="form-horizontal" id="b2b-form" method="POST">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-2 col-md-2 col-sm-3 form-control-label">
                                            <label for="bimages"> Business Images <br/>
                                                <p class="text-center"><small class="size10">(Max 5,  Max Total size 10MB)</small></p>
                                            </label>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-3 form-control-label">
                                            <label for="bvideo">Video <small><i> Format (mp4) & Max Size (5MB) 30Sec Only</i></small></label>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-3 form-control-label">
                                            <label for="pdf">Brochure <small><i> (PDF Only, Max Size 15MB)</i></small></label>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-3">
                                            <div class="form-group">
                                                <input type="file" id="pdf" name="pdf" class="form-control form_control" accept="application/pdf">
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-3">
                                        <div class="form-group">
                                            <?php
                                                if($pdf != ''){
                                                    $fileName = FCPATH."uploads/b2b/".$pdf;
                                                    if (file_exists($fileName)) {
                                                        $pdf_view = '
                                                            <a href="'.base_url().'uploads/b2b/'.$pdf.'" download>Download Brochure (PDF)</a> || <a href="'.base_url().'uploads/b2b/'.$pdf.'" target="_blank">View Brochure (PDF)</a>
                                                        ';
                                                    }else{
                                                        $pdf_view = '';
                                                    }
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-8 offset-sm-2 text-center">
                                        ...
                                        <input type="hidden" name="b2b_cancel_reason" id="b2b_cancel_reason" value="<?php echo $result['can_reason'] ?? '' ?>">
