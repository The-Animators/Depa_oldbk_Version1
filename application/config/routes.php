...
$route['admin/bulksms/new']					= 'masters/bulksms_new';
$route['admin/bulksms/list']				= 'masters/bulksms_list';
...
$route['admin/saadri/add']					= 'masters/saadri_add';
$route['admin/saadri/new/(:any)']			= 'masters/saadri_new/$1';
$route['admin/saadri/list']					= 'masters/saadri_list';
...
$route['admin/family/approve-member/(:num)']	= 'family/approvemember/$1';
...
$route['matrimonial/(:any)']				= 'web/matrimonial/$1';
$route['matrimonial_add']					= 'web/matrimonial_add';
$route['matrimonials']						= 'web/matrimonials';
$route['matrimonialdetail/(:any)']			= 'web/matrimonialdetail/$1';

$route['help_us/(:any)']					= 'web/help_us/$1';
$route['add_help_us']						= 'web/add_help_us';
$route['helpus']							= 'web/helpus';
$route['helpus_detail/(:num)']				= 'web/helpus_detail/$1';

$route['admin/helpus']						= 'admin/helpus';
$route['admin/helpus_detail/(:any)/(:any)']		= 'admin/helpus_view/$1/$2';
$route['admin/matrimonial']					= 'admin/matrimonial';
$route['admin/matrimonial_view/(:any)']		= 'admin/matrimonial_view/$1';
$route['admin/matrirequest']				= 'admin/matrirequest';

$route['admin/gallery_video/new']			= 'masters/gallery_video_new';
$route['admin/gallery_video/new/(:any)']	= 'masters/gallery_video_new/$1';
$route['admin/gallery_video/list']			= 'masters/gallery_video_list';

$route['gallery_video']						= 'web/gallery_video';
